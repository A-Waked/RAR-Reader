...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        UIFunctions.addNewMenu(self, "THUMBNAILS", "btn_thumbnails", "url(:/16x16/icons/16x16/cil-view-module.png)", True)
    ...
    def Button(self):
        ...
        # PAGE THUMBNAIL VIEW
        if btnWidget.objectName() == "btn_thumbnails":
            self.ui.stackedWidget.setCurrentWidget(self.ui.page_home)
            UIFunctions.resetStyle(self, "btn_thumbnails")
            UIFunctions.labelPage(self, "Thumbnail View")
            btnWidget.setStyleSheet(UIFunctions.selectMenu(btnWidget.styleSheet()))
